...
<html lang="en">
  ...
  <body>
      ...
      <div class="nav-bar black-color">
        <div class="nav-container black-color">
          ...
          <div class="nav-btn">
            <ul>
              ...
              <li id="nav-btn" class="theme-changer">
        ...
        <div class="menu-bar hidden-menu-bar">
          <ul>
            ...
            <li id="menu-btn">
              <a class="nav-btn-theme" href="#dashboard">Dashboard</a>
            </li>
            <li id="menu-btn">
              <a class="nav-btn-theme" href="#features">Features</a>
            </li>
            ...
            <li id="menu-btn" class="theme-changer">
              <i class="fas fa-sun"></i>
            </li>
          </ul>
        </div>
    ...
    <main>
      <div class="login-popup login-panel-hidden">
        <div class="login-card">
          ...
          <div class="login-forgot-pass">
            ...
            <p>
              New to Educare?
              <a href="#" id="login-register" class="register login-close"
                >Sign up</a
              >
            </p>
          </div>
      ...
      <div class="register-popup register-panel-hidden">
        <div class="register-card">
          ...
          <input type="password" id="register-pass" class="register-input" />
          <label for="confirm-pass">Confirm Password:</label>
          <input type="password" id="confirm-pass" class="register-input" />
          <div class="agree-checkbox">
            <input type="checkbox" required class="register-checkbox" />I agree
            to the terms and conditions
          </div>
          <div class="register-signin">
            Already have account?
            <a href="#" id="register-login" class="login register-close"
              >Login</a
            >
          </div>
          <div class="register-btn">
            <button id="register-submit">Register</button>
            <button id="register-close" class="register-close">Close</button>
          </div>
        </div>
      </div>
        ...
        <div class="contact-container">
          ...
          <div class="contact-right">
            <div class="contact-form">
              ...
              <textarea id="contact-msg">Type your message here</textarea>
      ...
      <div class="footer-container">
        <div class="footer-logo-box">
          ...
          <div class="footer-btn">
            ...
            <a id="footer-register" class="register button "
              >Register</a
            >
          </div>
        </div>
